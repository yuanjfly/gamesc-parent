...
public class RedisConfig extends CachingConfigurerSupport{
    ...
    @Bean("redisExchaneTemplate")
    public RedisTemplate<String, Object> redisAccountTemplate(
            @Qualifier("redisPool") GenericObjectPoolConfig redisPool,
            @Value("${spring.redis.exchange.host}") String host,
            @Value("${spring.redis.exchange.port}") int port,
            @Value("${spring.redis.exchange.database}") int db,
            @Value("${spring.redis.exchange.password}") String password) {
