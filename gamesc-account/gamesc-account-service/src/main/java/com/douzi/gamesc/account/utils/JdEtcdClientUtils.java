...
public class JdEtcdClientUtils {
    ...
    public void startListenerThread(String key,JSONObject cache,String cacheKey,long times){
        new Thread(()->{
            startListener(key,cache,cacheKey,times);
        }).start();
    }

    private void startListener(String key,JSONObject cache,String cacheKey,long times){
