package com.douzi.gamesc.user.config;
...
public class RedisConfig extends CachingConfigurerSupport{
    ...
    @Bean("redisAccountTemplate")
    public RedisTemplate<String, Object> redisAccountTemplate(
            @Qualifier("redisPool") GenericObjectPoolConfig redisPool,
            @Value("${spring.redis.account.host}") String host,
            @Value("${spring.redis.account.port}") int port,
            @Value("${spring.redis.account.database}") int db,
            @Value("${spring.redis.account.password}") String password) {
    ...
    public RedisTemplate<String, Object> redisUserTemplate(
            @Qualifier("redisPool") GenericObjectPoolConfig redisPool,
            @Value("${spring.redis.user.host}") String host,
            @Value("${spring.redis.user.port}") int port,
            @Value("${spring.redis.user.database}") int db,
