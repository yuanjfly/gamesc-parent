...
public class AESUtil {
        ...
        try {
            ...
            if (EncryptMode == "ECB") {
                ...
                IvParameterSpec iv = new IvParameterSpec(
                        Key.getBytes("utf-8"));//使用CBC模式，需要一个向量iv，可增加加密算法的强度
    ...
    public static void main(String[] args) throws Exception {
        String content = "22026";
        String password = "odaodzmj20200813";
        String s = AES_Encrypt(content, password, "ECB");
        System.out.println(s);
        System.out.println(AES_Decrypt("U6dfUu4okMJDWO4p1PAF6g==", password, "ECB"));
    }
